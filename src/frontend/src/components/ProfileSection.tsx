...
import { MonthlyStudySummaryView } from './MonthlyStudySummaryView';
import { StudyHeatmapView } from './StudyHeatmapView';
              ...
              <div className="space-y-6">
                ...
                {!isMaxLevel ? (
                  ...
                  <div className="rounded-lg border-2 border-primary bg-primary/5 p-6 text-center">
                    <p className="text-2xl font-bold mb-2">🎉 Maximum Level Reached!</p>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={updateProfileMutation.isPending}
            >
              {updateProfileMutation.isPending ? 'Removing...' : 'Remove'}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
